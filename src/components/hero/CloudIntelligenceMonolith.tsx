...
export const CloudIntelligenceMonolith: React.FC<CloudIntelligenceMonolithProps> = ({
  ...
  return (
    <div className="relative w-full py-6 lg:py-0 min-h-[640px] lg:h-[700px] flex items-center justify-center lg:justify-end overflow-hidden rounded-3xl bg-[#09090b] border border-white/5">
      ...
      */}
      <div className="relative z-10 w-full px-2 lg:px-12 flex justify-center lg:justify-end">
        <IntelligenceHub
          profile={profile}
          analytics={analytics}
          sync={sync}
